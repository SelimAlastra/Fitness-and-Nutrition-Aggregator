...
import type { Defined } from 'yup/lib/node_modules/yup/lib/util/types';
...
export default class BooleanSchema<TType extends Maybe<boolean> = boolean | undefined, TContext extends AnyObject = AnyObject, TOut extends TType = TType> extends BaseSchema<TType, TContext, TOut> {
    ...
    isTrue(message?: string | Record<string | number | symbol, unknown> | ((params: import("yup/lib/types").MessageParams) => unknown) | undefined): BooleanSchema<TType | true, TContext, true | Optionals<TOut>>;
    isFalse(message?: string | Record<string | number | symbol, unknown> | ((params: import("yup/lib/types").MessageParams) => unknown) | undefined): BooleanSchema<TType | false, TContext, false | Optionals<TOut>>;
}
